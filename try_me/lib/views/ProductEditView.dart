...
class _ProductEditViewState extends State<ProductEditView> {
  ...
  void saveInfo() {
    ...
    product.pricePerMonth = monthPriceController.text != null ? double.parse(monthPriceController.text) : 0.0;
    ...
    Request.modifyProduct(product).whenComplete(() => Navigator.pushNamedAndRemoveUntil(context, 'home', ModalRoute.withName('/')));
  }
