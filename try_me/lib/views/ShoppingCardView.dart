...
class _ShoppingCardViewState extends State<ShoppingCardView> {
  ...
  void checkout() async {
    ...
    //Place order
    result = await Request.order('eur', 'Rennes', 'France', '30 rue Oui', 35000);

    //Init stripe
    StripePayment.setOptions(
        StripeOptions(publishableKey: result['publishableKey'], merchantId: "merchantIdTest", androidPayMode: 'androidPayModeTest'));
                    ...
                    Expanded(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text('Total: $total€', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold)),
                        ),
                      ),
                    ),
                    Expanded(
