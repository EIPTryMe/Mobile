...
class PersonalInformationsView extends StatefulWidget {
  @override
  _PersonalInformationsViewState createState() => _PersonalInformationsViewState();
}
...
class _PersonalInformationsViewState extends State<PersonalInformationsView> {
  var edit = new List(7);
  double _widthScreen;
            ...
            children: <Widget>[
              ...
              RaisedButton(
                onPressed: () {
                  setState(() {
                    if (!edit[0]) {
                      //fonction de sauvegarde en bdd + quitter la page
                      print('Save and quit');
                    }
                  });
                },
